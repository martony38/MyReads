  ...
  <div className="book">
    <div className="book-top">
      <img
        ...
        src={props.book.imageLinks && props.book.imageLinks.thumbnail ? props.book.imageLinks.thumbnail : bookCoverDefault}
        style={!props.book.imageLinks || !props.book.imageLinks.thumbnail ? { boxShadow: "none", background: "none"} : {}}
